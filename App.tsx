  ...
  "emotionIntensity": 75
              ...
              <div className="space-y-6 bg-indigo-600/5 p-8 rounded-3xl border border-indigo-500/10">
                 ...
                 <ul className="space-y-4 text-xs text-slate-400 list-decimal list-inside leading-relaxed">
                   ...
                   <li>الصق الرابط الموضح في الجهة المقابلة.</li>
                   <li>فعل خيار <span className="text-white font-bold">Send Body</span>.</li>
                   <li>أضف الحقول الموضحة أعلاه (text, apiKey, pitch, emotionIntensity...).</li>
                   <li>في خيار <span className="text-white font-bold">Response Format</span>، اختر <span className="text-indigo-400 font-bold">File</span> لاستلام الـ WAV.</li>
                 </ul>
                 <div className="mt-8 pt-6 border-t border-indigo-500/10 flex items-center gap-3">
                   ...
                   <p className="text-[10px] italic">أصبح الـ API الآن يدعم التحكم الكامل في <span className="text-indigo-300 font-bold">حدة الصوت</span> و <span className="text-indigo-300 font-bold">قوة المشاعر</span> برمجياً.</p>
                 </div>
              </div>
            </div>
          </div>
